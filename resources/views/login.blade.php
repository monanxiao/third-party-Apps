        ...
        <div class="aui-content-box-fl">
          ...
          <div class="aui-form-content">
            <div class="aui-form-content-item" style="display: block;">
              <form action="https://www.17sucai.com/preview/1149930/2018-04-11/login/demo.html">
                ...
                <div class="aui-form-pwd clearfix">
                  <a href="https://www.17sucai.com/preview/1149930/2018-04-11/login/demo.html#">忘记密码？</a></div>
            ...
            <div class="aui-form-content-item" style="display: none;">
              <form action="https://www.17sucai.com/preview/1149930/2018-04-11/login/demo.html">
                ...
                <div class="aui-form-list">
                  ...
                  <a href="https://www.17sucai.com/preview/1149930/2018-04-11/login/demo.html#" class="aui-child aui-child-img">
        ...
        <div class="aui-content-box-fr">
          <div class="aui-content-box-text">
            ...
            <ul class="aui-content-box-text-link clearfix">
              <li>
                <a href="#" class="aui-icon-sina" title="使用新浪微博帐号登录"></a>
              </li>
              <li>
                <a href="#" class="aui-icon-wechat" title="使用微信帐号登录"></a>
              </li>
              <li>
                <a href="#" class="aui-icon-qq" title="使用腾讯QQ帐号登录"></a>
              </li>
              <li>
                <a href="#" class="aui-icon-baidu" title="使用百度帐号登录"></a>
              </li>
            </ul>
          </div>
        </div>
